...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Datapair.proto',
  package='ocr',
  serialized_pb=_b('\n\x0e\x44\x61tapair.proto\x12\x03ocr\"1\n\x08\x44\x61taPair\x12\x11\n\tdata_path\x18\x01 \x02(\t\x12\x12\n\ndata_label\x18\x02 \x02(\x05\"0\n\x0c\x44\x61taPairList\x12 \n\tdata_pair\x18\x01 \x03(\x0b\x32\r.ocr.DataPair')
)
